...
pygame.mixer.init()
hum_sound = pygame.mixer.Sound("hum_sound.mp3")
clicked_sound = pygame.mixer.Sound("clicked_sound.mp3")
start_sound = pygame.mixer.Sound("start_sound.mp3")
off_sound = pygame.mixer.Sound("off_sound.mp3")
bg_loop = pygame.mixer.Sound("bg_loop.mp3")
